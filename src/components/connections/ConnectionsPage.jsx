...
const ConnectionsPage = () => {
    ...
    const [connections, setConnections] = useState([
      { id: 1, name: 'Ramesh', role: 'Senior Developer at TechCorp', mutual: 4, connected: false },
      { id: 2, name: 'Arya', role: 'UX Designer at DesignHub', mutual: 2, connected: false },
      { id: 3, name: 'Rishi', role: 'Product Manager at InnovateCo', mutual: 5, connected: true },
      { id: 4, name: 'Deva', role: 'Data Scientist at AnalyticsPro', mutual: 3, connected: true },
      { id: 5, name: 'Riya', role: 'Frontend Developer at WebSolutions', mutual: 1, connected: false },
      { id: 6, name: 'Sai', role: 'Backend Engineer at DataSystems', mutual: 7, connected: false },
    ]);
...
<>
    <motion.div 
      ...
      className="max-w-4xl mx-auto p-4 lg:p-6 lg:absolute lg:left-130"
    >
      ...
      <div className="flex border-b border-gray-200 mb-6">
        <button
          className={`px-4 py-2 font-medium text-sm cursor-pointer flex items-center ${activeTab === 'suggestions' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'}`}
        ...
        <button
          className={`px-4 py-2 font-medium text-sm flex cursor-pointer items-center ${fshow===true ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'}`}
        ...
        <button
          className={`px-4 py-2 font-medium text-sm flex cursor-pointer items-center ${activeTab === 'mutual' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'}`}
    ...
    {fshow && (
    <div className="space-y-4 lg:absolute lg:right-8 lg:top-20 lg:w-1/4">
